...
<div class="p-3 list-group text-center">
    ...
    <a href="forms/superieur_a2.php" class="list-group-item list-group-item-action">Exemple Validateur pour vérifier qu'une valeur est supérieur à une autre valeur <i>(Melvin Pollier)</i></a>
